...
function setupEventListeners() {
    ...
    document.getElementById('generateCertificate').addEventListener('click', function() {
        showMessage('Certificate generation feature coming soon!', 'info');
    });
    
    // Next Challenge button
    document.getElementById('nextChallenge').addEventListener('click', function() {
        showMessage('Next challenge feature coming soon!', 'info');
    });
}
...
function copyCodeToEditor() {
    const solutionCode = document.querySelector('.solution-code code').textContent;
